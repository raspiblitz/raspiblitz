...
patch()
{
  ...
  CHOICE=$(whiptail --clear --backtitle "GitHub Sync/Patch Menu" --title "user:${activeGitHubUser} branch:${activeBranch} (${commitHashShort})" --menu "" 11 60 4 "${OPTIONS[@]}" 2>&1 >/dev/tty)
