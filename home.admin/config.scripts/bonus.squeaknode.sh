...
pinnedVersion="v0.1.171"

# command info
if [ $# -eq 0 ] || [ "$1" = "-h" ] || [ "$1" = "-help" ]; then
 echo "config script to switch the Squeaknode Service on,off or update"
 echo "bonus.squeanode.sh [on|off|menu|update]"
 exit 1
fi
...
# show info menu
if [ "$1" = "menu" ]; then
  dialog --title " Info Squeaknode Service " --msgbox "\n\
Usage and examples: https://github.com/yzernik/docs/getting_started.md\n
