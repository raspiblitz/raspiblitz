...
*The password A,B,C idea is based on the [RaspiBolt Guide Preparations](https://github.com/raspibolt/raspibolt/blob/master/preparations.md#write-down-your-passwords) - check out for more background.*
...
This feature is based on [https://github.com/raspibolt/raspibolt/blob/master/bonus/lightning/auto-unlock.md].
