...
If you start at home ordering the parts from Amazon (see shopping list below); or even better buy with Bitcoin ([ShopInBits.com]#https://shopinbit.com/en/concierge-service/361498/raspiblitz-kit) then it's a weekend project with a lot of downloading and syncing time where you can do other stuff while checking on the progress from time to time.
