...
- [What's new in Version 1.11.0 of RaspiBlitz?](CHANGES.md#whats-new-in-version-1110-of-raspiblitz)
...
`wget https://raw.githubusercontent.com/rootzoll/raspiblitz/v1.10/build_sdcard.sh && sudo bash build_sdcard.sh`
